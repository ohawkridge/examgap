...
export default async function getUser() {
  console.log(`%c getUser`, 'color:orange')
  const keyedClient = await createClient(localStorage.getItem('secret'))
  const qry = q.Let(
    {
                  ...
                  },
                  {
                    ...
                    course: q.Let(
                      ...
                      },
                      {
                        ...
                        board: q.Select(['data', 'board'], q.Var('cInstance')),
                        colour: q.Select(
                          ['data', 'colour'],
                          q.Var('cInstance')
                        ),
  ...
  const user = await keyedClient.query(qry)
